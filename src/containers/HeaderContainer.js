  ...
  return (
    <Banner bg={bg} source={source}>
        ...
        <HeaderWrapper.Container>
          <HeaderWrapper.Title bg={bg}>
            <HeaderWrapper.Link bg={bg} fixed={fixed} to="/">
              <img src="../public/logo_with_swoosh_and_name_to_side__1_-removebg-preview.png" alt="Eden Masters LTD Logo"/>
            </HeaderWrapper.Link>
          </HeaderWrapper.Title>
      ...
      {bg === "true" && (
        <Jumbotron>
          <Jumbotron.Left>
            <Jumbotron.Title>Real People, Real Services, Real Epiriences</Jumbotron.Title>
            <Jumbotron.Text>
              Explore our range of beautiful properties all over the country and talk to our trusted agents
            </Jumbotron.Text>
          </Jumbotron.Left>
          <Jumbotron.Right>
